...
Future<void> showAdminTaskGroupDialog(
  BuildContext context,
  AdminTaskGroupController ctrl,
  bool isDark, [
  TaskGroup? existing,
]) async {
          ...
          children: [
            ...
            Obx(
              () => TextFieldWidget(
                ...
                isRequired: true,
                errorText:
                    showNameError.value ? 'Task group name is required' : null,
                onChanged: (_) {
            ...
            TextFieldWidget(
              ...
              label: 'Description',
              hint: 'Short notes about this task group',
              isDark: isDark,
              maxLines: 3,
            ),
            const SizedBox(height: 20),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () async {
                  ...
                  final description = ctrl.descriptionCtrl.text.trim();
                  ...
                  bool success;
                  if (existing == null) {
                    success = await ctrl.createTaskGroup(
                      name: name,
                      color: ctrl.selectedColor.value,
                      description: desc,
                    );
                  } else {
                    success = await ctrl.updateTaskGroup(
                      existing.id,
                      name: name,
                      color: ctrl.selectedColor.value,
                      description: desc,
