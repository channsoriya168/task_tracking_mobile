...
class TaskCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isCompleted = statusName == 'done' || statusName == 'completed';
                      ...
                      Row(
                        children: [
                          ...
                          if (task.assignedToName != null) ...[
                            _AssigneeAvatar(name: task.assignedToName!),
  ...
  String _footerLabel(bool isOverdue) {
    ...
    if (task.dueDate == null) return task.status.name;
    final d = task.dueDate!;
    final datePart = '${d.day} ${m[d.month - 1]}';
    return isOverdue
        ? 'Overdue · $datePart'
        : '${task.status.name} · $datePart';
  }
}
