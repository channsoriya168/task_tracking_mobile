...
import 'package:task_tracking_mobile/presentation/pages/notification_page.dart';
              ...
              SliverPadding(
                ...
                sliver: SliverGrid(
                  delegate: SliverChildBuilderDelegate(
                    (context, index) {
                      const labels = ['Total', 'Pending', 'In Progress', 'Complete'];
                      const icons = [
                      ...
                      SingleChildScrollView(
                        ...
                        child: Row(
                          children: _kStatusFilters.map((status) {
                            final isSelected = taskCtrl.filterStatus.value == status;
                            ...
                            return GestureDetector(
                              ...
                              child: AnimatedContainer(
                                ...
                                decoration: BoxDecoration(
                                  color: isSelected ? color : (isDark ? kCardDark : Colors.white),
