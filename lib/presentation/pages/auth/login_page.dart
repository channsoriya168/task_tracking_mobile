...
class LoginPage extends StatelessWidget {
            ...
            children: [
              ...
              ..._roles.map((r) => _RoleCard(
                    ...
                    onTap: () => r.role == UserRole.staff
                        ...
                        : auth.login(kSampleUsers.firstWhere((u) => u.role == r.role)),
                  )),
            ],
          ),
        ),
  ...
  void _showStaffPicker(BuildContext context, AuthController auth, bool isDark) {
    final staffUsers = kSampleUsers.where((u) => u.role == UserRole.staff).toList();
    Get.bottomSheet(
      Container(
        decoration: BoxDecoration(
